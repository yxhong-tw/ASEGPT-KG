...
if __name__ == '__main__':
    ...
    parser.add_argument('-i',
                        '--articles_file_path',
                        type=str,
                        default='./processed_data/processed_all.json',
    ...
    parser.add_argument('-d',
                        '--docs_file_path',
                        type=str,
                        default='./bertopic/data/docs_processed_all.pkl',
                        help='Path to the documents file.')
    parser.add_argument('-k',
                        '--keywords_file_path',
                        type=str,
                        default='./bertopic/data/keywords_v2.txt',
                        help="Path to the keywords (don't split) file.")
    parser.add_argument('-m',
                        '--ckiptagger_model_path',
                        type=str,
                        default='./bertopic/data/ckiptagger/data',
